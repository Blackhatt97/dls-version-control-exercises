...
The concept and exercises are borrowed with shame from [Pragma training](https://github.com/praqma-training/git-katas). For more exercises, visit the link provided above.
...
A collection of useful git commands to use throughout the exercises:
